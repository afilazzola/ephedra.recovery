...
ggplot(foundation.rii, aes(year, abundance)) + geom_boxplot()
ggplot(foundation.rii, aes(year,richness)) + geom_boxplot()
...
ggplot(foundation.rii, aes(volume, abundance)) + geom_point() + geom_smooth(method = "lm")
ggplot(foundation.rii, aes(volume, richness)) + geom_point() + geom_smooth(method = "lm")
